...
auto qsystems::distosc::VD_1D::operator()(const std::complex<double> &x, const double &t)
-> std::complex<double>
{
    return 0.5*x*x + a * sin(w * t);
}

qsystems::distosc::VD_2D::VD_2D(double w1, double w2, double a1, double a2) : w1(w1), w2(w2), a1(a1), a2(a2) {};

auto qsystems::distosc::VD_2D::operator()(const std::complex<double> &x,
                                                 const std::complex<double> &y,
                                                 const double &t)
-> std::complex<double>
{
    return 0.5 * (x * x + y * y) + a1 * sin(w1*t) + a2 * sin(w2 * t);
}
...
auto qsystems::distosc::VD_3D::operator()(const std::complex<double> &x,
                                          const std::complex<double> &y,
                                          const std::complex<double> &z,
                                          const double &t)
-> std::complex<double>
{
    return 0.5 * (x*x + y*y + z*z) + a1 * sin(w1 * t) + a2 * sin(w2 * t) + a3 * sin(w3 *t);
}
...
-> std::complex<double>
{
    return 0.5 * (x*x + y * y) - l1 * x * sin(w1 * t) - l2 * y * sin(w2 * t);
}
...
auto qsystems::distosc::VD_lin_3D::operator()(const std::complex<double> &x,
                                                     const std::complex<double> &y,
                                                     const std::complex<double> &z,
                                                     const double &t)
-> std::complex<double>
{
    return 0.5 * (x * x + y * y + z * z) - l1 * x * sin(w1 * t) - l2 * y * sin(w2 * t) - l3 * z * sin(w3 * t);
}